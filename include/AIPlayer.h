    ...
    /**
     ...
     /** __  __ ___ ____    __  __ _____ _____ ___  ____   ___  ____  
        ...
        **/
        ...
        // Tercer Encuentro
        double Heuristica3(const Parchis &estado, int player);
        /**
        ...
        double evaluateItems(const Parchis& state, const int player) const;
        double podaAlphaBeta(const Parchis *state, const int depth, const int player, color &best_piece, int &best_piece_id, int &best_dice, bool maximizingPlayer, double alpha, double beta, double(*heuristica)(const Parchis&,int)) const;
        static double Heuristica4(const Parchis &state, int player);
        //-------------------------------
        double podaAlfaBeta(const Parchis *actual, const int max_prof, 
                              color &c_piece, int &id_piece, int &dice, 
                              double(*heuristica)(const Parchis&,int)) const;
        double podaAlfaBeta(const Parchis *actual, const int JUG_ALPHA, const int PROF_ACTUAL,
